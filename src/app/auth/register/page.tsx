...
import { Clapperboard, Mail, Lock, User, Loader2, Chrome, Gamepad2 } from 'lucide-react'
                ...
                <div className="glass-card p-8" style={{ boxShadow: '0 0 40px rgba(0,212,255,0.08)' }}>
                    <div className="flex gap-3 mb-5">
                        <button
                            ...
                            disabled={googleLoading || steamLoading || loading}
                            className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg border border-[#1e2a3a] bg-[#111827] text-[#e8edf5] hover:bg-[#1a2235] hover:border-[#2a3f5a] transition-all text-sm font-medium"
                        ...
                        <button
                            onClick={handleSteam}
                            disabled={googleLoading || steamLoading || loading}
                            className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg border border-[#1e2a3a] bg-[#171a21] text-white hover:bg-[#2a475e] hover:border-[#66c0f4] transition-all text-sm font-medium"
                            id="steam-register-btn"
                        >
